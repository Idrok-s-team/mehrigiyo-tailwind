...
const Modal: React.FC<IProps> = ({ isOpen, onSubmit, onClose, disabled = false, children }) => {
  ...
  return createPortal(
    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full overflow-hidden bg-gray-600 bg-opacity-50 animate-fade-in">
      <div className="max-w-[536px] min-h-[100px] flex flex-col gap-5 justify-between p-5 bg-white rounded-3xl animate-scale-in pb-[50px]">
